...
#show: template.with(
  title: "Typst 功能速览与样例",
  description: "这份文档展示了 Typst 的功能以及在当前网页模板下的效果。上方是实际渲染效果，下方的代码块是对应的源代码。",
...
这份文档展示了 Typst 的功能以及在当前网页模板下的效果。上方是实际渲染效果，下方的代码块是对应的源代码。原文来源于#link("https://github.com/Yousa-Mirage/Tufted-Blog-Template")[Tufted Blog Template 仓库]。
